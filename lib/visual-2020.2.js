...
import { mix, toNumerical, getPositionFromObject, toString, to_px, IsPointInsidePolygon, to_pixiPoint, to_unit } from './util-2020.2.js';
	...
	contains(object, units)
	{
		...
		if (typeof objectPos_px === 'undefined')
		{
			throw {
				...
				context: 'when determining whether ImageStim: ' + this._name + ' contains object: ' + toString(object),
	...
	contains(object, units)
	{
		...
		if (typeof objectPos_px === 'undefined')
		{
			throw {
				...
				context: 'when determining whether BaseShameStim: ' + this._name + ' contains object: ' + toString(object),
				error: 'unable to determine the position of the object'
			};
		}
	...
	contains(object, units)
	{
		...
		if (typeof objectPos_px === 'undefined')
		{
			throw {
				...
				context: 'when determining whether TextStim: ' + this._name + ' contains object: ' + toString(object),
				error: 'unable to determine the position of the object'
			};
		}
		return false;
